...
class GraphTest extends TestCase
{
    ...
    public function testSetNode()
    {
        ...
        $mock = $this->getMock('phpDocumentor\GraphViz\Node', [], [], '', false);
        $mock->expects($this->any())->method('getName')->will($this->returnValue('MyName'));
    ...
    public function testFindNode()
    {
        ...
        $mock2 = $this->getMock('phpDocumentor\GraphViz\Node', [], [], '', false);
    ...
    public function testLink()
    {
        ...
        $mock = $this->getMock('phpDocumentor\GraphViz\Edge', [], [], '', false);
